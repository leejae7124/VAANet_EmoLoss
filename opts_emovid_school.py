...
def parse_opts():
    ...
    arguments = {
        ...
        'paths': [
            ...
            dict(name='--root_path',
                 default="./tools/annotations/emovid",
                 type=str,
                 help='Global path of root directory'),
            dict(name="--video_path",
                 default="/shared/home/affctiv/sumin/EmoVid_split/EmoVidMovie_frames",
                 type=str,
            ...
            dict(name='--saliency_path',
                 default="/shared/home/affctiv/sumin/EmoVid_split/EmoVidMovie_saliency",
                 type=str,
            ...
            dict(name='--audio_path',
                 type=str,
                 default='/shared/home/affctiv/sumin/EmoVid_split/EmoVidMovie_audio',
