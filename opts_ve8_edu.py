    ...
    arguments = {
        ...
        'paths': [
            dict(name='--resnet101_pretrained',
                 default='/home/jovyan/work/prj_data/resnet-101-kinetics.pth',
                 type=str,
            ...
            dict(name="--video_path",
                 default="/home/jovyan/work/prj_data/VideoEmotion8--imgs",
                 type=str,
                 help='Local path of videos', ),
            dict(name="--annotation_path",
                 default='/home/jovyan/work/prj_data/ve8_02.json',
                 type=str,
            ...
            dict(name='--audio_path',
                 type=str,
                 default='/home/jovyan/work/prj_data/VideoEmotion8--mp3',
