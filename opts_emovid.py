    ...
    arguments = {
        ...
        'paths': [
            ...
            dict(name='--checkpoint_path',
                     default='/mnt/Members/leessu/EmoCam_weights/VAANet_saliency_weights/Saliency_EmoLoss/RMSEL_only/emovid_result_20260505_184655/checkpoints/save_1_0.3477.pth',
                 type=str,
                 help='Path of the saved model checkpoint (.pth)'),
            dict(name='--root_path',
                 default="/home/leessu/code/VAANet_Loss/tools/annotations/emovid",
                 type=str,
                 help='Global path of root directory'),
            dict(name="--video_path",
                 default="/home/leessu/dataset/EmoVid_split/EmoVidMovie_frames",
                 type=str,
            ...
            dict(name='--saliency_path',
                 default="/home/leessu/dataset/EmoVid_split/EmoVidMovie_saliency",
                 type=str,
            ...
            dict(name='--audio_path',
                 type=str,
                 default='/home/leessu/dataset/EmoVid_split/EmoVidMovie_audio',
